					...
					>
						...
						<div>
							...
							<p className='max-w-sm mb-16'>
								These projects have been made with react, javascript, Html, css, tailwind, bootstrap
								applying asynchronism for get requests, I am currently working on a complete
								e-commerce project where I would be working on redux in react, login routes, history
								of shopping etc
							</p>
							<button className='btn btn-sm'>
								<a
									href='https://github.com/WILLIAMJRR'
									target='_black'
								>
									View all proyects
								</a>
