        ...
        <div>
          <div className="flex-1">
            ...
            >
              ...
              🦸, horror and suspense 🧟🔪🔍. Your goal is
              to combine your programming skills and your
              passion for entertainment to create compelling
              and exciting online experiences for users.
            </motion.h3>
            <motion.p
              variants={fadeIn('right', 0.3)}
              initial="hidden"
              ...
              viewport={{ once: false, amount: 0.3 }}
            >
              I like to work in a team and share knowledge
              with my colleagues to achieve goals. I am a
              creative person who is passionate about the
            ...
            <div className="lg:flex lg:justify-around  ">
              <motion.div
                ...
                className=" mt-5"
              >
                <h2 className="text-gradient btn-link text-3xl mb-3">
                  Skill
                </h2>
