				...
				<div>
					<div className='flex-1'>
						...
						<motion.h3
							...
							className='h3 mb-4'
						>
							I'm a frontend Web Developer💻 As a passionate about web development, I focus on
							creating interactive and functional sites that meet the needs and preferences of
							customers. Also, I enjoy video games 🎮🕹️ and superhero movies 🦸, horror and suspense
							🧟🔪🔍. Your goal is to combine your programming skills and your passion for
							entertainment to create compelling and exciting online experiences for users.
						</motion.h3>
						<motion.p
							variants={fadeIn("right", 0.3)}
							initial='hidden'
							...
							viewport={{ once: false, amount: 0.3 }}
						>
							I like to work in a team and share knowledge with my colleagues to achieve goals. I am
							a creative person who is passionate about the world of programming.
						</motion.p>
						...
						<div className ="lg:flex lg:justify-around  ">
							...
							<motion.div
								...
								viewport={{ once: false, amount: 0.3 }}
							>
								<h2 className='text-gradient btn-link text-3xl mt-6'>Other Tools</h2>
